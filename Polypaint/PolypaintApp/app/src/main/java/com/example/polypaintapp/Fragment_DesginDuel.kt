...
import kotlinx.android.synthetic.main.design_duel.*
import kotlinx.android.synthetic.main.design_duel.PLAY
import kotlinx.android.synthetic.main.design_duel.buttonHelp
...
import kotlinx.android.synthetic.main.game_modes_choice.chatButton

class Fragment_DesginDuel : Fragment() {
    var imageList = intArrayOf(R.drawable.tut001, R.drawable.tut002, R.drawable.tut003, R.drawable.tut004)
    ...
    override fun onCreateView(
        ...
        inflater.inflate(R.layout.design_duel, container, false)!!
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        PLAY.setOnClickListener {VIEW ->
            ...
            VIEW.findNavController().navigate(R.id.action_fragment_Game_modes_to_fragment_Duel)
        ...
        buttonHelp.setOnClickListener {
            ...
            dialogView.tutorialViewFlipper.setDisplayedChild(3)
            dialog.show()
        }
