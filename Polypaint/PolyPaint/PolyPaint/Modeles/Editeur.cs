...
namespace PolyPaint.Modeles
{
    ...
    {
        public static string current = "crayon";
        ...
        private string previousColor = "Black";
        public string OutilSelectionne
        {
            get { return outilSelectionne; }
            set {
                DrawingPage.instance.surfaceDessin.UseCustomCursor = false;
                if (value == "efface_segment")
                {
                    DrawingPage.instance.surfaceDessin.UseCustomCursor = true;
                    couleurSelectionnee = "#FFFFFFFF";
                }
                else if (value == "crayon" && outilSelectionne != "crayon")
                    couleurSelectionnee = previousColor;
                outilSelectionne = value;
                current = outilSelectionne;
                ProprieteModifiee("CouleurSelectionnee");
                ProprieteModifiee(); }
        }
        ...
        public string CouleurSelectionnee
        {
            ...
            set
            {
                ...
                {
                    DrawingPage.instance.surfaceDessin.UseCustomCursor = true;
                    outilSelectionne = "efface_segment";
                }
