...
namespace PolyPaint.ParticleEffects
{
    //uielement
    //visual operations
    ...
    public class FireworkEffect : OverlayRenderDecorator
    {
        ...
        /*private async void OnMouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                AddRandomBurst(new Point(Random.NextDouble()*ActualWidth, Random.NextDouble()*ActualHeight));
            }
            

        }*/

        public async void startFirework()
        {
            for (int i = 0; i < 20; i++)
            {
                await Task.Delay(200);
